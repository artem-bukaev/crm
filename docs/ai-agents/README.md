...
Эта папка - обязательный контекст для Codex, Claude Code и других AI-агентов перед работой с проектом.

Цель документов - дать агенту достаточно контекста, чтобы он не ломал архитектурные границы, не менял технологический стек случайно и сохранял безопасную модель работы CRM с будущими AI-интеграциями.
